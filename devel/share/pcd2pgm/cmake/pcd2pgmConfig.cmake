...
if("TRUE" STREQUAL "TRUE")
  set(pcd2pgm_SOURCE_PREFIX /home/menonjay/robot_ws_1/src/robot_gazebo/pcd2pgm)
  set(pcd2pgm_DEVEL_PREFIX /home/menonjay/robot_ws_1/devel)
  set(pcd2pgm_INSTALL_PREFIX "")
  set(pcd2pgm_PREFIX ${pcd2pgm_DEVEL_PREFIX})
else()
  set(pcd2pgm_SOURCE_PREFIX "")
  set(pcd2pgm_DEVEL_PREFIX "")
  set(pcd2pgm_INSTALL_PREFIX /home/menonjay/robot_ws_1/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pcd2pgm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/menonjay/robot_ws_1/src/robot_gazebo/pcd2pgm/${idir}'.  ${_report}")
    endif()
