...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_description_SOURCE_PREFIX /home/menonjay/robot_ws_1/src/robot_gazebo/velodyne_simulator/velodyne_description)
  set(velodyne_description_DEVEL_PREFIX /home/menonjay/robot_ws_1/devel)
  ...
  set(velodyne_description_INSTALL_PREFIX /home/menonjay/robot_ws_1/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/menonjay/robot_ws_1/src/robot_gazebo/velodyne_simulator/velodyne_description/${idir}'.  ${_report}")
    endif()
